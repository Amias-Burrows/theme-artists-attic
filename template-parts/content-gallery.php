...
<div id='post'>
	<div id='meta'>
		...
		<p><strong><a href='<?php echo get_the_author_meta('user_url', $post->post_author) ?>'><?php echo get_the_author_meta('display_name', $post->post_author ) ?></a></strong> | <?php the_date(); ?></p>
