	...
	<div class='artists-masonry'>
		<div class='result'>
			...
			if (get_theme_mod('artists_masonry_element_1_image') != null) {
				...
				?><img id='thumbnail' src='<?php echo 'https://picsum.photos/1024/600?blur=3&random=1' ?>' alt='<?php echo get_theme_mod('artists_masonry_element_1_title') ?>'/><?php
			?>
			<div id='content'>
		...
		<div class='result'>
			...
			if (get_theme_mod('artists_masonry_element_2_image') != null) {
				...
				?><img id='thumbnail' src='<?php echo 'https://picsum.photos/1024/600?blur=3&random=2' ?>' alt='<?php echo get_theme_mod('artists_masonry_element_2_title') ?>'/><?php
			?>
			<div id='content'>
		...
		<div class='result'>
			...
			if (get_theme_mod('artists_masonry_element_3_image') != null) {
				...
				?><img id='thumbnail' src='<?php echo 'https://picsum.photos/1024/600?blur=3&random=3' ?>' alt='<?php echo get_theme_mod('artists_masonry_element_3_title') ?>'/><?php
			?>
			<div id='content'>
		...
		<div class='result'>
			...
			if (get_theme_mod('artists_masonry_element_4_image') != null) {
				...
				?><img id='thumbnail' src='<?php echo 'https://picsum.photos/1024/600?blur=3&random=4' ?>' alt='<?php echo get_theme_mod('artists_masonry_element_4_title') ?>'/><?php
			?>
			<div id='content'>
		...
		<div class='result'>
			...
			if (get_theme_mod('artists_masonry_element_5_image') != null) {
				...
				?><img id='thumbnail' src='<?php echo 'https://picsum.photos/1024/600?blur=3&random=5' ?>' alt='<?php echo get_theme_mod('artists_masonry_element_5_title') ?>'/><?php
			?>
			<div id='content'>
		...
		<div class='result'>
			...
			if (get_theme_mod('artists_masonry_element_6_image') != null) {
				...
				?><img id='thumbnail' src='<?php echo 'https://picsum.photos/1024/600?blur=3&random=6' ?>' alt='<?php echo get_theme_mod('artists_masonry_element_6_title') ?>'/><?php
			?>
			<div id='content'>
